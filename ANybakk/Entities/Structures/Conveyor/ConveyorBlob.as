...
namespace Transports {
  ...
  namespace ConveyorBlob {
    ...
    void onInit(CBlob@ this) {
      ...
      Transports::StructureBlob::onInit(this);
    ...
    void setTags(CBlob@ this) {
      ...
      this.set_u8("ConveyorBlobMode", Transports::ConveyorVariables::DEFAULT_MODE);
      
      //Set direction counter-clockwise
      this.set_u8("ConveyorBlobDirection", Transports::ConveyorVariables::DEFAULT_DIRECTION);
      
      //Store connection data (necessary for connecting segments with different connection rules)
      this.set("ConveyorBlobConnectionData", @Transports::ConveyorVariables::CONNECTION_DATA);
    ...
    void onSetStatic(CBlob@ this, const bool isStatic) {
      ...
      Transports::StructureBlob::onSetStatic(this, isStatic);
     ...
     */
    void updateConnections(CBlob@ this, CBlob@ previousBlob=null, Transports::ConveyorBlobConnectionData@ previousData=null, bool doPropagate=false, bool doAnimationSync=false, bool doSoundSync=false) {
    ...
    bool isCompatible(CBlob@ this, CBlob@ other) {
      ...
      Transports::ConveyorBlobConnectionData[]@ thisConnectionData;
      ...
      //Create an arrays of connection data object references
      Transports::ConveyorBlobConnectionData[]@ otherConnectionData;
