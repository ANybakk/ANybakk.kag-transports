...
namespace ANybakk {
  ...
  namespace ConveyorVariables {
    ...
    const ANybakk::ConveyorBlobConnectionData[] CONNECTION_DATA = { 
      ...
      ANybakk::ConveyorBlobConnectionData("isConnectedUp", Vec2f(0.0f, -8.0f), CONNECTION_DATA_VERTICAL_ORIENTATIONS, CONNECTION_DATA_COMPATIBILITIES),
      ...
      ANybakk::ConveyorBlobConnectionData("isConnectedDown", Vec2f(0.0f, 8.0f), CONNECTION_DATA_VERTICAL_ORIENTATIONS, CONNECTION_DATA_COMPATIBILITIES),
